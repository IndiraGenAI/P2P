...
@Index("grn_invoices_pkey", ["id"], { unique: true })
@Index("grn_invoices_grn_invoice_number_key", ["grn_invoice_number"], {
  unique: true,
})
@Entity("grn_invoices", { schema: "public" })
export class GrnInvoice {
  ...
  @Column("integer", { name: "grn_id", nullable: false })
  grn_id: number;
  ...
  @ManyToOne(() => Grn, { onDelete: "RESTRICT", nullable: false })
